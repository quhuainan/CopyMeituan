...
export default class NearbyScene extends React.Component<any, any> {
    static navigationOptions = (({ navigation }: any) => ({
        headerRight: (<TouchableOpacity style={styles.searchBar}>
        ...
        return (
            ...
            >
                {titles.map((title, index) => {
                    return <NearbyListScene tabLabel={title} key={index} types={types[index]} navigation={this.props.navigation}>{title}</NearbyListScene>
                })}
